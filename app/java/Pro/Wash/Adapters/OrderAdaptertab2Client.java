...
public class OrderAdaptertab2Client extends BaseAdapter implements ListAdapter {
    ...
    public OrderAdaptertab2Client(@NonNull Context context, ArrayList<String> OID,
    ...
    private void sendNotification(String OID) {
        ...
        mRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Notify notify =
                        new Notify(token,"Out for Pickup","Our Pickup boy will be on your doorstep");
                notify.execute();
            }
